...
// import api from '../api/axios'
// import toast from 'react-hot-toast'
// // import { fetchUser } from '../redux/userSlice'   // ✅ make sure this import exists
...
//   const handleFollow = async () => {
//     try {
//       const token = await getToken() // ✅ token ek hi baar
...
//       if (data.success) {
//         toast.success(data.message)
//         dispatch(fetchUser(token)) // ✅ Redux state refresh
//       } else {
//         toast.error(data.message)
//       }
//     } catch (error) {
...
//           className={`w-full py-2 rounded-md flex justify-center items-center gap-2 text-white transition
//             ${
//               isFollowing
