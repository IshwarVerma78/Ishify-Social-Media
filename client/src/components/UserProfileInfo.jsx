...
const UserProfileInfo = ({ user, posts, profileId, setShowEdit }) => {
  return (
    <div className="relative bg-white px-6 md:px-8 pt-20 pb-6">
      
      {/* Profile Image */}
      <div className="absolute -top-16 left-6 w-32 h-32 rounded-full border-4 border-white shadow-lg bg-white overflow-hidden">
        <img
      ...
      <div className="md:pl-40">
        ...
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
          ...
          <div>
            ...
            {/* Bio */}
            <p className="text-gray-700 text-sm max-w-md mt-2 leading-relaxed">
              {user.bio}
            </p>
          ...
          {!profileId && (
            <button
              ...
              className="flex items-center justify-center gap-2 border border-gray-300 px-4 py-2 rounded-lg text-sm font-medium hover:bg-gray-50 transition cursor-pointer"
            >
